...
import java.io.*;
import java.sql.*;  
    public class AddNewRoute extends JFrame {
	...
	private static String info;
		...
		txtRouteNo = new JTextField(10); //txtRouteNo.setEditable(false);
		txtRouteName = new JTextField(10);
		txtFrom= new JTextField(10);
		txtTo = new JTextField(10);
		txtAmount=new JTextField(10);
        txtDistance = new JTextField(15);
		AddNew = new JButton("ADD NEW",new ImageIcon("INF/save.png"));
		Cancel = new JButton("CANCEL",new ImageIcon("INF/cancel.png"));
...

      {
	   ...
	   txtRouteNo.addKeyListener(new KeyAdapter()
	   {
		   public void keyTyped(KeyEvent e)
		   {
				  ...
				  (c == KeyEvent.VK_DELETE)))
			   {
				   ...
				   getToolkit().beep();
				   JOptionPane.showMessageDialog(null, "Route No Should be in Digit only !", "ERROR",
	   ...
	   txtRouteName.addKeyListener(new KeyAdapter() {
         public void keyTyped(KeyEvent e) {
           ...
           if (!(Character.isLetter(c) ||
             ...
             getToolkit().beep();
             JOptionPane.showMessageDialog(null,"This Field Accepts text only !","ERROR",
             JOptionPane.DEFAULT_OPTION);
             e.consume();
           }
         }
       ...
       txtAmount.addKeyListener(new KeyAdapter() {
         public void keyTyped(KeyEvent e) {
           ...
           if (!(Character.isDigit(c) ||
             ...
             getToolkit().beep();
             JOptionPane.showMessageDialog(null,"Amount should be in Digit !","ERROR",
             JOptionPane.DEFAULT_OPTION);
             e.consume();
           }
         }
       ...
       txtDistance.addKeyListener(new KeyAdapter() {
         public void keyTyped(KeyEvent e) {
           ...
           if (!(Character.isDigit(c) ||
             ...
             getToolkit().beep();
             JOptionPane.showMessageDialog(null,"Distance should be in Digit !","ERROR",
             JOptionPane.DEFAULT_OPTION);
             e.consume();
           }
         }
		...
		AddNew.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(null,"Please Enter route number !","ERROR",
                JOptionPane.DEFAULT_OPTION);
                txtRouteNo.requestFocus();
                return;}
                if (txtRouteName.getText() == null ||
                txtRouteName.getText().equals("")){
					JOptionPane.showMessageDialog(null, "Please Enter route name !", "ERROR",
                JOptionPane.DEFAULT_OPTION);
                txtRouteName.requestFocus();
                return;}
                if (txtFrom.getText() == null ||
                txtFrom.getText().equals("")){
					JOptionPane.showMessageDialog(null, "Please Enter ' From ' !", "ERROR",
                JOptionPane.DEFAULT_OPTION);
                txtFrom.requestFocus();
                return;}
                if (txtTo.getText() == null ||
                txtTo.getText().equals("")){
					JOptionPane.showMessageDialog(null, "Please Enter ' To' ", "ERROR",
                JOptionPane.DEFAULT_OPTION);
                txtTo.requestFocus();
                return;}
                if (txtDistance.getText() == null ||
                txtDistance.getText().equals("")){
					JOptionPane.showMessageDialog(null, "Please Enter - Distance", "ERROR",
                JOptionPane.DEFAULT_OPTION);
	...
	JFrame.setDefaultLookAndFeelDecorated(true);
		...
		new AddNewRoute().setVisible(false);
	}
