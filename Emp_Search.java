...
class Emp_Search extends JFrame
{
	...
	public Emp_Search(String str)
	{
		...
		reportingPanel.add(new JLabel("Employee Search"), BorderLayout.NORTH);
		...
		listPane = new JTextArea()
		{
			...
			public void paint(Graphics g)
			{
				...
				g.drawString("Employee Search Result", 385, 70);
	...
	private void printList(String ss)
	{
		try
		{
			...
			ResultSet.CONCUR_UPDATABLE).executeQuery("select empNo,Fname,Mname,Lname,Gender from Employee where Fname ='" + ss + "'");


			listPane.append("\n\n\n\n\n\n\n\n\n\n\n\n\n");
			listPane.append("     empNo" + "\t\t" + "Fname" + "\t\t" + "Mname" + "\t\t" + "Lname\t" + "\tGender\n");
			while (rst.next())
			{
				listPane.append("\n       ");
